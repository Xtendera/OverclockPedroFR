...
//                .build();
        ...
        push2Sample = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(startPose), new Point(pushPre1ControlPose), new Point(pushPre1Control2Pose), new Point(pushPre1Pose)))
                .setLinearHeadingInterpolation(startPose.getHeading(), pushPre1Pose.getHeading())
